...
from viitegeneraattori import viitegeneraattori as default_v_gen

class Kauppa:
    def __init__(self, varasto=default_varasto, pankki=default_pankki, viitegen=default_v_gen):
