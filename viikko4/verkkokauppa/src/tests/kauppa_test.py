...
class TestKauppa(unittest.TestCase):
    ...
    def test_ostot_kaksi_eri_tuotetta_oikea_veloitus(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
    ...
    def test_ostot_kaksi_samaa_tuotetta_oikea_veloitus(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("pekka", "12345")
    ...
    def test_ostot_toinen_tuote_loppu(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
    ...
    def test_uusi_asiakas_uusi_ostoskorin_sisältö(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
    ...
    def test_uusi_asiakas_uusi_viitenumero(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("pekka", "12345")
